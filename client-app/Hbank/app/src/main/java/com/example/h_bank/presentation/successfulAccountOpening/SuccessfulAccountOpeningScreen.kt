...
fun SuccessfulAccountOpeningScreen(
    ...
    LaunchedEffect(key1 = true) {
        viewModel.navigationEvent.collect { event ->
            when (event) {
                SuccessfulAccountOpeningNavigationEvent.NavigateToMain -> navController.navigate("main")
                SuccessfulAccountOpeningNavigationEvent.NavigateBack -> navController.popBackStack()
            }
        }
    }
