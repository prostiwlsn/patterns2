...
import com.example.h_bank.presentation.registration.components.RegistrationBottomText
import com.example.h_bank.presentation.registration.components.RegistrationForm
import com.example.h_bank.presentation.registration.components.RegistrationHeader
    ...
    LaunchedEffect(Unit) {
        viewModel.navigationEvent.collect { event ->
            when (event) {
                ...
                RegistrationNavigationEvent.NavigateBack -> navController.popBackStack()
            }
        }
    }
