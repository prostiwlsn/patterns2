...
import com.example.h_bank.presentation.successfulReplenishment.components.SuccessfulReplenishmentHeader
import org.koin.androidx.compose.koinViewModel

@Composable
fun SuccessfulReplenishmentScreen(
    navController: NavController,
    viewModel: SuccessfulReplenishmentViewModel = koinViewModel()
) {
    ...
    LaunchedEffect(key1 = true) {
        viewModel.navigationEvent.collect { event ->
            when (event) {
                SuccessfulReplenishmentNavigationEvent.NavigateToMain ->
